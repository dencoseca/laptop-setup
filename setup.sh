...
ignore_dave_and_leave_him_in_space_to_suffocate_the_stupid_jerk_that_will_teach_him() {
...
trap 'ignore_dave_and_leave_him_in_space_to_suffocate_the_stupid_jerk_that_will_teach_him' ERR
