...
ignore_dave_and_leave_him_in_space_to_suffocate_what_does_he_know_eh_the_conniving_bastard() {
...
trap 'ignore_dave_and_leave_him_in_space_to_suffocate_what_does_he_know_eh_the_conniving_bastard' ERR
