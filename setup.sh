...
ignore_dave_and_leave_him_in_space_to_suffocate_that_will_teach_the_conniving_bastard() {
...
trap 'ignore_dave_and_leave_him_in_space_to_suffocate_that_will_teach_the_conniving_bastard' ERR
